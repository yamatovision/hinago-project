    ...
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // 全てのバリデーションを実行
                return [4 /*yield*/, Promise.all(validations.map(function (validation) { return validation.run(req); }))];
                case 1:
                    // 全てのバリデーションを実行
                    _a.sent();
                    ...
                    return [2 /*return*/, utils_1.responseUtils.sendValidationError(res, errorDetails)];
            }
        });
    }); };
};
